...
function initialise() {
	...
	L0101 = theMenu.addChild(L01, "Document", "销售机会管理", "sale/salesLickController/getLickList?pageNow=1&pageSize=10", "销售机会管理...");
	L0102 = theMenu.addChild(L01, "Document", "客户开发计划", "sale/salesPlanContrller/getSalesPlanList?pageNow=1&pageSize=10", "客户开发计划...");

	
	L02 = theMenu.addChild(l2ID, "Folder", "客户管理", "", "客户管理...");
	L0201 = theMenu.addChild(L02, "Document", "客户信息管理", "cust/cust/customerController/getCustomers?pageNo=1&pageSize=10", "客户信息管理...");
...
if (theBrowser.IE){
	...
	self.document.writeln('<frameset rows="*" cols="160,*" border="0"  noresize framespacing="2">'); 
		...
		self.document.writeln('<frame name="menu" src="menu.jsp"  border="0" scrolling="auto" marginwidth="0"  leftmargin="0" marginheight="0" APPLICATION="yes">');
	self.document.writeln('<frame name="text" src="footer.jsp"  frameborder="no"  marginwidth="0" marginheight="0" APPLICATION="yes">');
	self.document.writeln('</frameset>');
}
